...
# select the branch to play with
_branch="tcp-cca-rfc"
_srcname=rust4lx-${_branch}
_srctag=${pkgver}-${pkgrel}
source=(
  ${url}/archive/refs/heads/${_branch}.zip
  config
)
sha256sums=('48e0f1f951ac5db2cb40916c5c2028040a8348f2c4154832689ffa77d005269e'
            'db02b8ab527eb3f43f17537d7065afbe8f35ef4bab34bd7d55a2792f784843c8')
b2sums=('f68d68b380124b77b0eb3c751332f8d0b44d385d22219de7f748cbd40aa43214d8a2351dfd93ade6cd614d173bc9e2566d677ca32d53abfeb29dad2eecd21c2b'
        '91f2d44aa6d0d7b53dc171fc835c175dedb65f82474bf28e1799e02565ca444ab9fc2ef4689b30a92a8d82484556edafdb24e32f796a55230e2079d518283e5a')
...
_package-headers() {
  ...
  local resolve_btfids="tools/bpf/resolve_btfids/resolve_btfids"
  if [[ -x "$resolve_btfids" ]]; then
    install -Dt "$builddir/tools/bpf/resolve_btfids" "$resolve_btfids"
  fi
